...
📌 Saya terbuka untuk kolaborasi dalam proyek digital marketing, content writing, atau konsultasi strategi SEO.
...
### 🛠️ Tools & Platforms
`SEO` `Backlink Strategy` `Keyword Research` `Content Writing` `Technical SEO` `Manual Outreach`  
